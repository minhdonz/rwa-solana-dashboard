...
export const ISSUERS: Issuer[] = [
  ...
  },
  {
    ...
    name: "Dinari (dShares)",
    shortName: "Dinari",
    tagline: "US-accredited model — registered transfer-agent rails.",
    summary:
      "Dinari issues dShares, tokenized US equities aimed at US-accredited investors via registered transfer-agent infrastructure. It anchors the 'compliant US access' end of the spectrum: more onboarding friction, but a regulated path for eligible US persons that the offshore SPV products do not offer.",
    tickerStyle: "dShares (e.g. dAAPL)",
    website: "https://dinari.com",
    rights: {
      legalWrapper: {
        value: "Registered (transfer agent)",
        verdict: "good",
        note: "Operates with registered transfer-agent infrastructure targeting compliant US access — a different regulatory posture from offshore SPV trackers.",
        source: "https://eco.com/support/en/articles/15254023-tokenized-equities-2026-backed-dinari-robinhood",
      },
      backing: {
        value: "1:1 backed",
        verdict: "good",
        note: "dShares are backed by the underlying equities held in custody.",
        source: "https://eco.com/support/en/articles/15254023-tokenized-equities-2026-backed-dinari-robinhood",
      },
      voting: {
        value: "Generally none",
        verdict: "bad",
        note: "Primarily price exposure; governance rights not the model.",
        source: "https://eco.com/support/en/articles/15254023-tokenized-equities-2026-backed-dinari-robinhood",
      },
      dividends: {
        value: "Processed by issuer",
        verdict: "partial",
        note: "Dividends/corporate actions handled through the registered issuer rails.",
        source: "https://eco.com/support/en/articles/15254023-tokenized-equities-2026-backed-dinari-robinhood",
      },
      redemption: {
        value: "Issuer / transfer-agent",
        verdict: "partial",
        note: "Mint/redeem via the registered issuer; eligibility-gated.",
        source: "https://eco.com/support/en/articles/15254023-tokenized-equities-2026-backed-dinari-robinhood",
      },
      transferability: {
        value: "KYC / accredited",
        verdict: "partial",
        note: "Access restricted to KYC'd, accredited US investors — higher friction, more compliance.",
        source: "https://eco.com/support/en/articles/15254023-tokenized-equities-2026-backed-dinari-robinhood",
      },
      defi: {
        value: "Limited",
        verdict: "partial",
        note: "Compliance gating reduces permissionless DeFi composability versus xStocks.",
        source: "https://eco.com/support/en/articles/15254023-tokenized-equities-2026-backed-dinari-robinhood",
      },
      eligibility: {
        value: "US-accredited",
        verdict: "neutral",
        note: "Targets accredited US investors — the inverse of the non-US xStocks/Ondo audience.",
        source: "https://eco.com/support/en/articles/15254023-tokenized-equities-2026-backed-dinari-robinhood",
      },
      chains: {
        value: "Multi-chain",
        verdict: "neutral",
        note: "Issued across multiple chains.",
        source: "https://eco.com/support/en/articles/15254023-tokenized-equities-2026-backed-dinari-robinhood",
      },
    },
  },
